...
This konnector is a simple POC for a 2FA auth.
...
The lead maintainers for this konnector is @m4dz 🍺
...
_Cozy Konnector 2FA Demo_ is developed by @m4dz 🍺 and distributed under the [AGPL v3 license][agpl-3.0].
